    ...
    return WillPopScope(
        ...
        child: Scaffold(
            ...
            body: Column(children: [
              ...
              Visibility(
                  child:
                      SpeechBubble(true, BubbleType.topSessionStart, context),
              ...
              Visibility(
                  child: SimpleButton("Start session", () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: ((context) =>
                                const SessionCountdownView())));
                  }),
                  visible: bottomSpeechBubble == null),
              Visibility(
                  child: SpeechBubble(
                      true, BubbleType.bottomBuddyProgress, context),
                  visible:
                      bottomSpeechBubble == BubbleType.bottomBuddyProgress),
              Visibility(
                  child:
                      SpeechBubble(true, BubbleType.bottomSessionIcon, context),
